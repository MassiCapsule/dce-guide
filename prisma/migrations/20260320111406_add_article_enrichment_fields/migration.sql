...
INSERT INTO "new_Guide" ("createdAt", "criteria", "currentStep", "errorMessage", "guideCompletionTokens", "guideGenerationCost", "guideHtml", "guideHtmlV2", "guideModelUsed", "guidePromptTokens", "guidePromptUsed", "guideWordCount", "id", "mediaId", "planHtml", "seoKeywords", "seoScore", "serpanticsGuideId", "status", "title", "totalCost", "updatedAt", "wordCountMax", "wordCountMin") SELECT "createdAt", "criteria", "currentStep", "errorMessage", "guideCompletionTokens", "guideGenerationCost", "guideHtml", "guideHtmlV2", "guideModelUsed", "guidePromptTokens", "guidePromptUsed", "guideWordCount", "id", "mediaId", "planHtml", "seoKeywords", "seoScore", "serpanticsGuideId", "status", "title", "totalCost", "updatedAt", "wordCountMax", "wordCountMin" FROM "Guide";
DROP TABLE "Guide";
