...
CREATE TABLE "new_Media" (
    ...
    "planOutputStructure" TEXT NOT NULL DEFAULT '',
    "modelPlan" TEXT NOT NULL DEFAULT '',
    "forbiddenWords" TEXT NOT NULL DEFAULT '',
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL
);
INSERT INTO "new_Media" ("createdAt", "defaultProductWordCount", "description", "doRules", "dontRules", "forbiddenWords", "id", "modelPlan", "name", "productStructureTemplate", "promptPlan", "toneDescription", "updatedAt", "writingStyle") SELECT "createdAt", "defaultProductWordCount", "description", "doRules", "dontRules", "forbiddenWords", "id", "modelPlan", "name", "productStructureTemplate", "promptPlan", "toneDescription", "updatedAt", "writingStyle" FROM "Media";
DROP TABLE "Media";
