...
CREATE TABLE "new_Guide" (
    ...
    "guideHtmlV2" TEXT NOT NULL DEFAULT '',
    "articleSummary" TEXT NOT NULL DEFAULT '',
    "chapoHtml" TEXT NOT NULL DEFAULT '',
    "sommaireHtml" TEXT NOT NULL DEFAULT '',
    "criteresHtml" TEXT NOT NULL DEFAULT '',
    "faqHtml" TEXT NOT NULL DEFAULT '',
    "metaTitle" TEXT NOT NULL DEFAULT '',
    "metaDescription" TEXT NOT NULL DEFAULT '',
    "imageCaption" TEXT NOT NULL DEFAULT '',
    "slug" TEXT NOT NULL DEFAULT '',
    "h1Alternatives" TEXT NOT NULL DEFAULT '[]',
...
INSERT INTO "new_Guide" ("articleSummary", "chapoHtml", "createdAt", "criteresHtml", "criteria", "currentStep", "errorMessage", "faqHtml", "guideCompletionTokens", "guideGenerationCost", "guideHtml", "guideHtmlV2", "guideModelUsed", "guidePromptTokens", "guidePromptUsed", "guideWordCount", "id", "imageCaption", "mediaId", "metaDescription", "metaTitle", "planHtml", "planJson", "seoKeywords", "seoScore", "serpanticsGuideId", "slug", "sommaireHtml", "status", "title", "totalCost", "updatedAt", "wordCountMax", "wordCountMin") SELECT "articleSummary", "chapoHtml", "createdAt", "criteresHtml", "criteria", "currentStep", "errorMessage", "faqHtml", "guideCompletionTokens", "guideGenerationCost", "guideHtml", "guideHtmlV2", "guideModelUsed", "guidePromptTokens", "guidePromptUsed", "guideWordCount", "id", "imageCaption", "mediaId", "metaDescription", "metaTitle", "planHtml", "planJson", "seoKeywords", "seoScore", "serpanticsGuideId", "slug", "sommaireHtml", "status", "title", "totalCost", "updatedAt", "wordCountMax", "wordCountMin" FROM "Guide";
DROP TABLE "Guide";
